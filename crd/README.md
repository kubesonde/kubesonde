...
```sh
make docker-build docker-push IMG=<some-registry>/kubesonde:tag
```
...
```sh
make deploy IMG=<some-registry>/kubesonde:tag
```
...
```sh
make build-installer IMG=<some-registry>/kubesonde:tag
```
