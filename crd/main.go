...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "6bebd5fd.kubesonde.io",
	})
	if err != nil {
	...
	if err = (&controllers.KubesondeReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("Kubesonde"),
